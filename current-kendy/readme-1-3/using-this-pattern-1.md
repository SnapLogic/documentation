...
The self-contained data has 2 outputs: one comparing the current record with the next record and the other comparing the current record with the previous record.
