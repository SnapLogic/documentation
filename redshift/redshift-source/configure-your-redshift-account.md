...
* **JDBC JARs**: The list of JDBC jar files to be loaded.
...
* **Advanced propertie**s: The advanced properties to support this account.
  * **Auto commit**: Select this checkbox to enable the Snap to commit offsets automatically.
...
* Url properties: Click the + icon to add the following URL properties associated with this account.
  * Url property name
  * Url property value
