...
* [Dropbox Samples via REST API](current/pattern\_34-1/README.md)
...
* [Call a command line utility on the Snaplex node](<current/pattern\_34-2/README (1).md>)
...
* [Batch sync new leads from Marketo to Amazon Redshift](current/pattern\_34-3/README.md)
