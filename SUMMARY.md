...
* [Batch Sync New Leads From Marketo to Amazon Redshift](<current/pattern\_34-2/README (1).md>)
  * [Overview](<current/pattern\_34-2/overview (2).md>)
  * [Requirements](<current/pattern\_34-2/requirements (2).md>)
  * [Using this Pattern](current/pattern\_34-2/using-this-pattern.md)
* [Copy of Batch sync new leads from Marketo to Amazon Redshift](<current/pattern\_34-2/README (2).md>)
  * [Overview](current/pattern\_34-2/overview.md)
  * [Requirements](current/pattern\_34-2/requirements.md)
  * [Using this Pattern](<current/pattern\_34-2/using-this-pattern (2).md>)
* [Copy of Copy of Batch sync new leads from Marketo to Amazon Redshift](current/pattern\_34-3/README.md)
  * [Overview](<current/pattern\_34-3/overview (1).md>)
  * [Requirements](<current/pattern\_34-3/requirements (1).md>)
  * [Using this Pattern](current/pattern\_34-3/using-this-pattern.md)
* [Copy of Copy of Copy of Batch sync new leads from Marketo to Amazon Redshift](<current/pattern\_34-4/README (1).md>)
  * [Overview](current/pattern\_34-4/overview.md)
  * [Requirements](current/pattern\_34-4/requirements.md)
  * [Using this Pattern](current/pattern\_34-4/using-this-pattern.md)
* [Create Records in AWS Redshift for New CSVs in Box](<current/pattern\_34-5/README (1).md>)
  * [Overview](<current/pattern\_34-5/overview (1).md>)
  * [Requirements](<current/pattern\_34-5/requirements (1).md>)
  * [Using this Pattern](<current/pattern\_34-5/using-this-pattern (1).md>)
* [Check Failed Pipelines Details in a Specific Org](<current/pattern\_34-6/README (1).md>)
  * [Overview](<current/pattern\_34-6/overview (1).md>)
  * [Requirements](<current/pattern\_34-6/requirements (1).md>)
  * [Using this Pattern](<current/pattern\_34-6/using-this-pattern (1).md>)
* [Call a Command Line Utility on the Snaplex Node](<current/pattern\_34-7/README (1).md>)
  * [Overview](<current/pattern\_34-7/overview (1).md>)
  * [Requirements](<current/pattern\_34-7/requirements (1).md>)
  * [Using this Pattern](<current/pattern\_34-7/using-this-pattern (1).md>)
* [Dropbox Samples via REST API](<current/pattern\_34-8/README (1).md>)
  * [Overview](<current/pattern\_34-8/overview (1).md>)
  * [Requirements](<current/pattern\_34-8/requirements (1).md>)
  * [Using this Pattern](<current/pattern\_34-8/using-this-pattern (1).md>)
* [Enable or Disable a Task](<current/pattern\_34-9/README (1).md>)
  * [Overview](<current/pattern\_34-9/overview (1).md>)
  * [Requirements](<current/pattern\_34-9/requirements (1).md>)
  * [Using this Pattern](<current/pattern\_34-9/using-this-pattern (1).md>)
